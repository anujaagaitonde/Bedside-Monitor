...
As the device is intended to be used modularly where the patient may only have one or two of the three available sensors plugged in to measure only some of their vital signs. All Software for the device had to allow for this functionality. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTM5Njg4NDYsLTk2NTcyOTUxNCwxMjU4MT
MyMDA3LDMwMjA3ODksODA4MjY0NDU2LDE0MTE1MTg0NzUsNzQ0
ODEyMzM4XX0=
-->