...
**Respirationprocess:** Responsible for processing raw ECG data pushed into  ECGraw queue and estimating heart rate, respiration and respiration rate which are then pushed to be locally displayed and pushed to the database. This is done in a completely seperate process so that not to hinder the reading of ECG data from the ADC with RR peak detection, heart rate calculation and well .
**DBprocess:** 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODI2OTAwNjQsLTk5NDQ2MjA1NywxND
