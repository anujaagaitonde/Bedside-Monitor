...
**Tempprocess:** Responsible for reading temperature data from the DS18B20 sensor and pushing it to the and in a completely seperate process so that is only run if the temperature sensor is plugged in and will not effect other processes.
**PPGread**: Responsible for reading PPG data from the MAX30102 sensor  
**PPGprocess:**
**ECGprocess:**
**Respirationprocess:**
**DBprocess:**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTU5NzA0NDIsLTk2NTcyOTUxNCwxMj
