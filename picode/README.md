...
As the device is intended to be used modularly where the patient may only have one or two of the three available sensors p
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NzEwNjExMiwtOTY1NzI5NTE0LDEyNT
