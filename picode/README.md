...
**ECGprocess:** Responsible for reading ECG data from the MCP3008 ADC which in turn is reading from the AD8232
**Respirationprocess:**
**DBprocess:**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTgxNTk2MzEsLTk2NTcyOTUxNCwxMj
