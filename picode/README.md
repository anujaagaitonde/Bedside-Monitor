...
**PPGprocess:** Responsible for processing raw PPG data pushed from the PPGread queue and outputting spo2 and pulse rate values that are then pushed into queues for displaying locallyy and pushing to the database. This is in a completely seperate process such that not to hinder the reading of the raw values from the sensors with the intensive algorithms used to compute SPO2 and pulse rate. As they 
**ECGprocess:**
**Respirationprocess:**
**DBprocess:**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjIzNDEzNzAzLC05NjU3Mjk1MTQsMTI1OD
