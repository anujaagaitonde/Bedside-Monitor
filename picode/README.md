...
**ECGprocess:** Responsible for reading ECG data from the MCP3008 ADC which in turn is reading from the analogue AD8232 sensor.  
**Respirationprocess:**
**DBprocess:**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMTAwMTE0NjUsLTk2NTcyOTUxNCwxMj
